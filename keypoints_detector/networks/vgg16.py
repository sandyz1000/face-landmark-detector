...
def get_vgg_encoder(input_height=224, input_width=224, pretrained='imagenet', channels=3):
    ...
    x = KL.MaxPooling2D((2, 2), strides=(2, 2), name='block1_pool',
    ...
    x = KL.MaxPooling2D((2, 2), strides=(2, 2), name='block2_pool',
                        data_format=IMAGE_ORDERING)(x)
    f2 = x
    ...
    x = KL.MaxPooling2D((2, 2), strides=(2, 2), name='block3_pool',
                        data_format=IMAGE_ORDERING)(x)
    f3 = x

    # Block 4
    x = KL.Conv2D(512, (3, 3), activation='relu', padding='same',
                  name='block4_conv1', data_format=IMAGE_ORDERING)(x)
    x = KL.Conv2D(512, (3, 3), activation='relu', padding='same',
                  name='block4_conv2', data_format=IMAGE_ORDERING)(x)
    x = KL.Conv2D(512, (3, 3), activation='relu', padding='same',
                  name='block4_conv3', data_format=IMAGE_ORDERING)(x)
    x = KL.MaxPooling2D((2, 2), strides=(2, 2), name='block4_pool',
                        data_format=IMAGE_ORDERING)(x)
    f4 = x
    ...
    x = KL.MaxPooling2D((2, 2), strides=(2, 2), name='block5_pool',
                        data_format=IMAGE_ORDERING)(x)
    f5 = x
