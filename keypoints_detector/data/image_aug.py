...
def _augment_seg(img, seg, augmentation_name, prefix="_apply_aug"):
    ...
    image_aug = _apply_augmentation(img, aug_det.augment_image, is_tensor=isinstance(img, tf.Tensor))
...
def _augment_keypoints(img, keypoints, augmentation_name, prefix="_apply_aug"):
    ...
    keymap_aug = _apply_augmentation(keypoints, aug_det.augment_keypoints,
